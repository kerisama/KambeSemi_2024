...
# def generate_multiple_circles(pressure_value):
#     circle_count = max(1,pressure_value // 200)
#     circles = []
#     for _ in range(circle_count):
#         x,y,radius,color,speed = generate_circle()
#         circles.append((x,y,radius,color,speed))
#     return circles
