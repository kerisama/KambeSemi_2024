...
def main():
    ...
    print("getXY test: ", x, y)
    
    print("isRange test1: ", isRange(x, y))
    ...
    print("isRange test2: ", isRange(x, y))

    print()
    """
    """
    sleep(1)
    print("servo_tof_test:1")
    servo_tof_test(timing)
    
    sleep(1)
    print("servo_tof_test:2")
    servo_tof_test(timing)
    
    sleep(1)
    print("servo_tof_test:3")
    servo_tof_test(timing)
    """
